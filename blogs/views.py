...
def index(request):
    ...
    host1 = "ec2-3-213-192-58.compute-1.amazonaws.com"
    password1 = '5bd21fea51e24b05df8b86f211f15656a8b7d6555476b1d6321fcb991aa51495'
    conn = psycopg2.connect(host=host1,port="5432" ,database="d4t3h1sjbavvbc", user="ztvknlgnpzbrsq", password=password1)
...
def ibook(request):
    ...
    try:
        ...
        postgres_insert_query = """ INSERT INTO book (b_id, b_name, b_page,b_year) VALUES (%s,%s,%s,%s)"""
        record_to_insert = (str(id1), str(name), int(page), str(year))
